...
<template>
  <div class="flex flex-col gap-1.5">
    ...
    <input
      ...
      :class="[
        'rounded-xl border bg-[var(--bg-surface)] px-4 py-2.5 text-sm text-[var(--text-primary)] placeholder-[var(--text-tertiary)] transition-colors duration-150 outline-none',
